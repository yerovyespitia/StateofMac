  ...
  return (
    <motion.div whileHover={{ scale: 1.013 }} whileTap={{ scale: 0.9 }}>
      <Link href={`/games/${game.title}`} passHref>
        <div className="m-4 flex cursor-pointer flex-col items-center rounded-lg bg-[#292929] hover:bg-[#363636] md:flex-row">
          <div className="mx-0 mt-12 mb-4 md:m-5 md:h-auto md:w-auto">
            <Image
              src={game.wallpaper}
              width={374}
              height={221}
          ...
          <div className="flex flex-col items-center justify-center text-center md:block md:text-left">
            <p className="my-1 mx-0 text-2xl font-bold text-white">
              {game.title}
            </p>
