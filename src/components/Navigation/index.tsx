  ...
  return (
    ...
    >
      {menuItems.map(({ href, label }) => (
        <ul
          className='text-center flex mb-2 w-full md:mr-3 md:w-[140px]'
          key={label}
        >
          <Link href={href} className='w-full'>
            <motion.li
              className='text-md h-14 pt-4 rounded-md bg-[#292929] font-bold text-[#dbdbdb] hover:bg-[#363636] md:w-[140px] md:rounded-full'
              whileTap={{ scale: 0.9 }}
              onClick={() =>
                label === 'Logout'
